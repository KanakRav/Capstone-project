...
var collided = false;
function preload() {
  zombie1 = loadImage("./assets/m.png");

  zombie2 = loadImage("./assets/m.png");
  
  sadzombie = loadImage("./assets/sm.png");

  backgroundImage = loadImage("./assets/castle2.jpeg");
}
